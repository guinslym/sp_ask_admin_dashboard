...
class Client(object):
    ...
    def load_config(self, profile = None):
        ...
        if os.name == 'nt':
            ...
            if os.path.exists(os.path.expanduser(config_file)) and os.path.exists(os.path.expanduser(credentials_file)):
                config.read([os.path.expanduser(config_file), os.path.expanduser(credentials_file)])
