...
def get_transcript(request, *args, **kwargs):
    ...
    return render(request, 'transcript/transcript.html', {'object_list':transcript, 'queue_name':queue_name, "started_date":started_date, 'chat_id':chat_id})
...
def download_transcript_in_html(request, *args, **kwargs):
    ...
    guest_id  = str(transcript_metadata.get('guest').get('jid')) + "/"+ str(transcript_metadata.get('guest_id')) 
