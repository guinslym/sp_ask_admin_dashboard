    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('totalchatpermonth_thisyear', models.CharField(blank=True, max_length=1000, null=True)),
                ('totalchatpermonth_lastyear', models.CharField(blank=True, max_length=1000, null=True)),
                ('chats_yesterday', models.CharField(blank=True, max_length=2000, null=True)),
                ('chats_per_month_lastyear', models.CharField(blank=True, max_length=2000, null=True)),
                ('chats_per_month_thisyear', models.CharField(blank=True, max_length=2000, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Transcript',
            fields=[
                ...
                ('referenceQuestion', models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['referenceQuestion'], name='dashboard_t_referen_acde3a_idx'),
        ),
    ]
