...
from dashboard.utils.ask_schools  import  find_school_by_operator_suffix , find_school_abbr_by_queue_or_profile_name
...
def get_duration_from_2_timestamps(started, ended):
	...
	total_time=(datetime.datetime.strptime(ended,'%H:%M:%S') - datetime.datetime.strptime(started,'%H:%M:%S'))
	return total_time
...
def get_new_window_url_for_transcript(lh3id):
	return "https://ca.libraryh3lp.com/dashboard/queues/ANYTHING/calls/ANYTHING/"+str(lh3id)
