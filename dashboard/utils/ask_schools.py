...
sp_ask_school_dict = [
    {"school":{
        'id':1 ,
        'queues':["toronto","toronto-mississauga","toronto-scarborough","toronto-st-george", "toronto-st-george-proactive"],
        'suffix':['_tor'], 
        'short_name':'toronto', 
    ...
    {"school":{
        'id':3 ,
        'queues':["western","western-fr","western-proactive","western-txt",],
    ...
    {"school":{
        'id': 4,
        'queues':["carleton-txt","carleton", "carleton-access-services-txt", "carleton-access-services", ],
        'suffix':['_car'], 
        'short_name':'Carleton', 
    ...
    {"school":{
        ...
        {"school":{
        'id': 19,
        'queues':["scholars-portal","scholars-portal-txt", "scholars portal", "clavardez", "clavardez-txt"],
        'suffix':['_sp'], 
        ...
        {"school":{
        'id': 21,
        'queues':["practice-webinars","practice-webinars-fr","practice-webinars-txt"],
        'suffix':[], 
...
SMS_QUEUES = ['carleton-txt', 'clavardez-txt', 'guelph-humber-txt',
            ...
            'scholars-portal-txt', 'western-txt', 'york-txt', 'txt-carleton-access-services', 'carleton-access-services-txt']
